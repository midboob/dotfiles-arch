...
if [ "$choice" -eq 1 ]; then
  ...
  clear
  chmod +x ~/Dotfiles/InstallScripts/rofiinstall.sh && ~/Dotfiles/InstallScripts/rofiinstall.sh
  ...
  clear
  chmod +x ~/Dotfiles/InstallScripts/ohmyposhinstall.sh && ~/Dotfiles/InstallScripts/ohmyposhinstall.sh
